...
| 2025 | [Yap – Social Media Platform](https://github.com/SaherZaid/Yap) | A full social media system with posts, stories, hashtags, friends, likes. | ASP.NET MVC · EF Core · HTML . TailwindCSS · .css  |
| 2024 | [REST API + Blazor E-Commerce](https://github.com/SaherZaid/E-commerce-REST-API-and-Blazor-Frontend-Development) | Two-phase project: REST API with Repository Pattern + JWT + Blazor client frontend. | .NET 8 · JWT · Repository Pattern · UoW . HTML . TailwindCSS · .css |
